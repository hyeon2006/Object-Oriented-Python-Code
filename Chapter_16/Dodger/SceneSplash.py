...
import pyghelpers
import pygwidgets
from Constants import SCENE_HIGH_SCORES, SCENE_PLAY, SCENE_SPLASH
...
class SceneSplash(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.backgroundImage = pygwidgets.Image(  # The line `self.backgroundImage =
            # pygwidgets.Image(self.window, (0, 0),
            # "images/splashBackground.jpg")` is creating an image
            # object for the splash screen background.
            self.window,
            (0, 0),
            "images/splashBackground.jpg",
        )
